...
<body>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					aria-expanded="false"><img width="20" height="20"
						src="../../upload/<%=uif.getHeadImg()%>" alt=""> <span
						class="caret"></span></a>
	...
	<div class="col-md-5">
			...
			<div class="form-group">
				...
				<p class="form-control-static"><%=uif.getNname() %></p>
			</div>
			<div class="form-group">
				<label for="exampleInputPassword1">介绍</label> 
				<p class="form-control-static"><%=uif.getIntroduction() %></p>
			</div>
			<div class="form-group">

				<label for="exampleInputPassword1">性别</label> 
				<p class="form-control-static"><%=uif.getSex() %></p>
			</div>
			<div class="form-group">
			<label for="exampleInputPassword1">生日</label> 
				<p class="form-control-static"><%=uif.getBirthday() %></p>
			</div>
			<a href="updateprofile.jsp" class="btn btn-success" >修改</a>
